...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"postHandler.js":[function(require,module,exports) {
"use strict";
...
var _postHandler = require("./postHandler.js");
...
if (currentPost) {
  currentPost.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (editPost) {
  editPost.addEventListener('submit', function (e) {
    e.preventDefault();
    var post = JSON.parse(editPost.dataset.post);

    if (e.submitter.innerHTML === 'Submit') {
      var title = document.getElementById('editTitle').value;
      var content = document.getElementById('editBody').value;
      (0, _postHandler.updatePost)(post, title, content);
